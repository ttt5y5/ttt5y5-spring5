...
public class HomeController {
	...
	/**
	 * 사용자요청 (웹브라우저)을 받아서=@RequestMapping인터페이스 사용해서 메서드명을 스프링 구현합니다
	 * ,route(루트root X)
	 * return 값으로 view(jsp)를 선택해서 작업한 결과를 변수로 담아서화면에 전송 후 결과를 표시(렌더링)합니다
	...
	public String home(Model model) { //콜백메서드,자동실행됨
		...
		//home.jsp 파일로 자료를 전송하는 기능model인터페이스 객체(스프링이처리)에 내용만 채우면됨
