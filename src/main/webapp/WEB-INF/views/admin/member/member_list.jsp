          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr style="cursor: pointer;" onclick="location.replace('/admin/member/member_view?search_type=${pageVO.search_type}&search_keyword=${pageVO.search_keyword} user_id=${memberVO.user_id}');">
