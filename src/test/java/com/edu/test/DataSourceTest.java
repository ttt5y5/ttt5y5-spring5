...
public class DataSourceTest {
	...
	//dataSource 데이터베이스객체를 pool로 저장해서 사용할때 DataSource 클래스 사용(아래)
	@Inject //스프링에서 객체를 만드는 방법 , 자바8부터 지원 
	DataSource dataSource; //객체의 메모리 관리를 스프링이 대신함
	@Test
