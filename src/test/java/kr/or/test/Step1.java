...
public class Step1 {
	...
	//내부변수(매서드변수)는 main매서드 내부에서만 영향을 주는 변수
	//private String name;//멤버변수 사용에, Step2클래스에서 사용예정
	public static void main(String[] args) {
		...
		//변수에 값을 입력(아래)
		name = "홍길동";
		age = 10; //자바스크립트 보다는 자료형 사용에 엄격함
		phoneNum = "000-0000-0000"; //1문자 끝을 명시
		printMember(name, age, phoneNum);//프린트멤버 매서드를 호출
		name = "성춘향" ;
		age = 18;
		...
		printMember(name, age, phoneNum);
		//배열을 이용해서 입력을 좀더 편리하게 변경함
		String[] names = {"홍길동","성춘향","각시탈"};
		int[] ages = {10,18,28};
		String[] phoneNums = {"000-0000-0000","111-111-1111","222-2222-2222"};
		printMember(names, ages, phoneNums); //매서드명이 같지만, 로드된 파라미터 다른 매서드를 호출 = 오버로드
	}
	...
	private static void printMember(String name, int age, String phoneNum) { //printMember(파라미터1, param2, param3)
		System.out.println("입력하신 회원의 이름은 "+name+"님, 나이는 "+age+", 폰번호는 "+phoneNum);
		//println 매서드는 출력 후 줄바꿈 명령실행  ln = line new
