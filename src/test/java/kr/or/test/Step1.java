...
public class Step1 {
	...
	public static void main(String[] args) {
		...
		// 변수 값을 입력 (아래)
		name = "홍길동";
		age = 10; //자바스크립트 보다는 자료형 사용에 엄격합니다. ""문자열로 인식
		...
		printMember(names, ages, phoneNums); //장점: 메서드 1번호출하면 3명이 모두출력 
		//메서드명이 같습니다. 단, 로드된 파라미터가 다른 메서드를 호출 =오버로드 (loding...)
