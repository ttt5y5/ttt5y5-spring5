...
- 문서작업(제출용)예정.
- 관리자대시보드에서 회원ID 이미지업로드 및 보이기 처리예정.(기술참조 https://github.com/miniplugin/ttt5y5 )
...
- C:\egov\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\ttt5y5-spring5\resources\profile
...
- 2. DB생성 스크립트 실행
- 3. DB매니저실행하기
- 현재 까지 작업한 소스를 여러분 이름 도메인으로배포예정 ttt5y5-spring5.herokuapp.com
...
- 람다식사용예 : https://github.com/miniplugin/SQLite-ttt5y5/blob/master/app/src/main/java/com/human/sqlite_ttt5y5/MainActivity.java
...
- https://github.com/miniplugin/spring5-ttt5y5/blob/master/src/test/java/kr/or/test/ClassApp.java
